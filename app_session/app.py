...
class AppSession(object):
    ...
    def _integrity_error_handler(self, error):
        ...
        if hasattr(flask.g, "s"):
            flask.g.s.rollback()
            flask.g.s.close()
        error = self.app.api.get_error(
            "Value should be unique or reference incorrect or other integrity error", [], 400
        )
    ...
    def init_app(self, app):
        ...
        # self.app.teardown_appcontextget_session(self._finish_session)
